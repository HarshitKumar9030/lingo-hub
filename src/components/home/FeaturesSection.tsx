        ...
        >
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="h-full p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-lg border border-gray-200 dark:border-gray-700 transition-all duration-300">
                {/* Icon */}
